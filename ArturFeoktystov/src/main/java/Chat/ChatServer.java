...
public class ChatServer {
    ...
    // loop and are responsible for a dealing with a single client and broadcasting its messages.
    private static class Handler extends Thread {
        ...
        public void run() {
            try {
                ...
                // Note that checking for the existence of a name and adding the name must be done while locking the set of names.
                while (true) {
                ...
                // Now that a successful name has been chosen, add the socket's print writer to the set of all writers so
