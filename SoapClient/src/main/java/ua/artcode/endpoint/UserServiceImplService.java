 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://endpoint.artcode.ua/", wsdlLocation = "http://192.168.1.40:9999/ws/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://endpoint.artcode.ua/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.40:9999/ws/user?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://endpoint.artcode.ua/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint.artcode.ua/", "UserServiceImplPort"), UserService.class, features);
    }
